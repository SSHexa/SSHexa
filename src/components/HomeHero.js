        ...
        <div className="sh-hero-visual">
          <div className="sh-visual-wrapper">
            <div className="sh-workflow-card">
              <div className="sh-workflow-step sh-step-1">
                ...
                <span className="sh-step-status sh-status-active">Hexa Robotics</span>
              </div>
              <div className="sh-workflow-connector"></div>
              <div className="sh-workflow-step sh-step-2">
                ...
                <span className="sh-step-status sh-status-active">SS Hexa CRO</span>
              </div>
              <div className="sh-workflow-connector"></div>
              <div className="sh-workflow-step sh-step-3">
                ...
                <span className="sh-step-status sh-status-active">PractiCloud</span>
              </div>
            </div>
          </div>
        </div>
